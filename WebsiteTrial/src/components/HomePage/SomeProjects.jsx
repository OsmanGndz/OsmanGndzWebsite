...
const SomeProjects = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center text-black dark:text-zinc-100">
      <h1 className="w-full text-[24px] lg:text-[32px] flex flex-row items-center justify-between">
        ...
        <div
          className="w-32 justify-end items-end text-[16px] lg:text-[20px] bg-blue-100 dark:bg-neutral-700 inline-block text-center text-black dark:text-zinc-100 rounded-xl shadow-sm shadow-gray-400 dark:shadow-gray-500 cursor-pointer py-1 hover:scale-103 transform duration-500"
      ...
      <div className="w-full pt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <div
            ...
            className={`relative flex flex-col rounded-xl shadow-md max-w-full h-80 p-2 pr-4 pb-4 cursor-pointer hover:scale-103 transform duration-500 bg-white dark:bg-neutral-800 ${
          ...
          >
            ...
            <div className="flex items-end justify-end w-full z-15">
              <img
                src={project.picture}
                alt="sdas"
                className="w-[85%] h-52 rounded-lg shadow-md shadow-gray-400 dark:shadow-gray-600"
              />
            </div>
          </div>
        ))}
